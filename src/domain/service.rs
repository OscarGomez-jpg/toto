...
impl TaskServicePort for TaskService {
    fn execute_command(
        &self,
        command: Box<dyn crate::domain::command::Command>,
    ) -> Result<crate::domain::command::CommandResult, Box<dyn Error>> {
    ...
    fn add_task(
        ...
        self.repository
            .add(title, description, start_date, end_date)
    }
    ...
    fn update_task(
        ...
        self.repository
            .update_task(id, title, description, start_date, end_date)
    }
    ...
    fn add_relation(
        ...
        use crate::domain::task::{RelationType, TaskRelation};
    ...
    fn remove_relation(&self, source_id: String, target_id: String) -> Result<(), Box<dyn Error>> {
        ...
        self.repository
            .remove_relation(source_id.clone(), target_id.clone())?;
...
mod tests {
    ...
    fn test_add_relation_two_way() {
        ...
        mock_repo
            ...
            .with(
                eq("1".to_string()),
                predicate::function(|r: &crate::domain::task::TaskRelation| {
